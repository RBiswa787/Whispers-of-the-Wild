...
public class FirstPersonController : MonoBehaviour
{
    ...
    public TMP_Text chatOutputField;
  ...
  private bool isTyping = false;
    ...
    void Start()
    {
        ...
        chatOutputField.gameObject.SetActive(false);
    ...
    public void ActivateChatInput()
    {
        ...
        chatOutputField.gameObject.SetActive(true);
        chatInputField.gameObject.SetActive(true); // Make sure it's visible
        sendButton.gameObject.SetActive(true);
        panel.gameObject.SetActive(true);
        sendButton.gameObject.SetActive(true);
        chatInputField.text = "Ask here..."; // Clear previous text
        chatOutputField.text = "Press TAB again to exit conversation mode.";
        chatInputField.ActivateInputField(); // Focus for typing

        // Optional: Lock cursor if needed
        Cursor.lockState = CursorLockMode.None;
        Cursor.visible = true;
    }

    public void DeactivateChatInput()
    {
        isTyping = false;
        playerCanMove = true;

        chatInputField.DeactivateInputField();
        chatInputField.gameObject.SetActive(false); // Hide input after typing
        chatOutputField.gameObject.SetActive(false);
        chatScrollView.gameObject.SetActive(false);
        sendButton.gameObject.SetActive(false);
        panel.gameObject.SetActive(false);
        sendButton.gameObject.SetActive(false);
        // Optional: Re-lock cursor for FPS
        Cursor.lockState = CursorLockMode.Locked;
